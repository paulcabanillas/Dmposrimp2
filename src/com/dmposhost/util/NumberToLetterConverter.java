...
public class NumberToLetterConverter {
    ...
    public static String convertNumberToLetter(double doubleNumber)
        ...
        if (millon == 1)
            converted.append("SON: UN MILLON ");
        else if (millon > 1)
            converted.append("SON: ")
        ...
        if(miles>=1 || millon>=1){
            ...
            if (cientos == 1)
                converted.append("SON: UN ");
            if (cientos > 1)
                converted.append("SON: ").append(convertNumber(String.valueOf(cientos)));
        }

        if (millon + miles + cientos == 0)
            converted.append("SON: CERO ");
